...
app = FastAPI(title="FastAPI + MariaDB (async)", version="1.0.1")

DB_HOST = os.getenv("DB_HOST", "container_mariadb")
...
async def root() -> Dict[str, Any]:
    return {"message": "Hello World from Python Python (FastAPI + MariaDB, async)"}
